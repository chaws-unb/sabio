...
struct symbol {		
  ...
  double value; /*holds the symbol’s value as a variable*/
  struct ast *func;	/* the func field points to the AST for the user code for the function */
  struct symlist *syms; /* syms points to a linked list of the dummy arguments */
};
