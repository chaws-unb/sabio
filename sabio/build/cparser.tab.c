...
#line 32 "par/cparser.y"
    { (yyval.a) = newAbstractTree('+', (yyvsp[(1) - (3)].a),(yyvsp[(3) - (3)].a)); ;}
    break;
...
#line 42 "par/cparser.y"
    { (yyval.a) = newAbstractTree('|', (yyvsp[(2) - (2)].a), NULL); ;}
    break;
...
#line 44 "par/cparser.y"
    { (yyval.a) = newAbstractTree('M', (yyvsp[(2) - (2)].a), NULL); ;}
    break;



/* Line 1455 of yacc.c  */
#line 1411 "cparser.tab.c"
      default: break;
    }
